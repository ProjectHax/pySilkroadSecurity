...
#define MAXKEYSIZE 		56		// 448 bits max
...
bool BlowfishPIMPL::Initialize( const void * const key_ptr, int32_t key_size )
{
	if( key_size == 0 || key_size > MAXKEYSIZE )
	{
		return false;
	}
...
int32_t BlowfishPIMPL::GetOutputLength( int32_t input_size )
{
	int32_t lVal = 0;
...
bool BlowfishPIMPL::Encode( const void * const input_ptr, int32_t input_size, void * output_ptr, int32_t output_size )
{
	int32_t lCount, lOutSize, lGoodBytes;
	uint8_t * pi, * po;
	int32_t i, j;
...
// output buffer can be the same, but be sure buffer length is even MOD 8.
bool BlowfishPIMPL::Decode( const void * const input_ptr, int32_t input_size, void * output_ptr, int32_t output_size )
{
	int32_t lCount;
	uint8_t *pi, *po;
	int32_t i;
...
bool Blowfish::Initialize( const void * const key_ptr, int32_t key_size )
{
	return m_BlowfishPIMPL.Initialize( key_ptr, key_size );
}

int32_t Blowfish::GetOutputLength( int32_t input_size )
{
	return m_BlowfishPIMPL.GetOutputLength( input_size );
}

bool Blowfish::Encode( const void * const input_ptr, int32_t input_size, void * output_ptr, int32_t output_size )
{
	return m_BlowfishPIMPL.Encode( input_ptr, input_size, output_ptr, output_size );
}

bool Blowfish::Decode( const void * const input_ptr, int32_t input_size, void * output_ptr, int32_t output_size )
{
